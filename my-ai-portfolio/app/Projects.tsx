...
const projects: Project[] = [
  { id: 'ai-desktop-os', title: 'AI Desktop OS', subtitle: 'Interactive OS with AI Integration', image: '/wallpaper3.png', githubUrl: 'https://github.com/dave21-py/ai-desktop-os', category: 'web-dev', year: '2025', tech: ['Framer Motion', 'HTML' ,'Tailwind CSS', 'Javascript'], description: 'AI Desktop OS featuring dynamic AI chat interface, fluid animations, and responsive design. Built with modern web technologies and optimized for performance.', impact: 'Showcases full-stack development capabilities and modern UI/UX principles', features: [ 'AI-powered chat interface', 'Fluid WebGL animations', 'Responsive design system', 'Performance optimized', 'Accessibility compliant' ], metrics: { stars: 2, commits: 103 }, teamSize: 'Solo Project', duration: '2 weeks' },
  { id: 'ai-portfolio', title: 'AI Portfolio Website', subtitle: 'Interactive Portfolio with AI Integration', image: '/portfolio.png', githubUrl: 'https://github.com/dave21-py/ai-portfolio', category: 'web-dev', year: '2025', tech: ['Next.js', 'React', 'Framer Motion', 'Tailwind CSS', 'TypeScript'], description: 'Personal portfolio featuring dynamic AI chat interface, fluid animations, and responsive design. Built with modern web technologies and optimized for performance.', impact: 'Showcases full-stack development capabilities and modern UI/UX principles', features: [ 'AI-powered chat interface', 'Fluid WebGL animations', 'Responsive design system', 'Performance optimized', 'Accessibility compliant' ], metrics: { stars: 12, commits: 67 }, teamSize: 'Solo Project', duration: '1 month' },
