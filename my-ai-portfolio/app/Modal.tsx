      ...
      >
        ...
        <div className="p-2 md:p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 p-4 md:p-6">
            ...
            {/* Left Column: Image */}
            <div className="md:col-span-1 bg-gradient-to-b from-blue-50 to-blue-100 rounded-2xl flex items-center justify-center p-4">
              <img
...
Personal Email: davidspurgeongeddam@gmail.com
        ...
        <div className="border-t border-gray-200 bg-gray-50 px-6 py-3 flex justify-center">
          <button className="text-sm text-gray-500 hover:text-gray-900 flex items-center gap-2 transition-colors">
            <FaChevronUp />
            Back to front
          </button>
        </div>
